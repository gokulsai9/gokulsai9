...
Description:
This project involved scraping T20 cricket player data from ESPNcricinfo using BrightData, performing extensive data cleaning using Pandas, and analyzing player performance metrics across categories (openers, anchors, finishers, all-rounders, bowler performance). I then developed an interactive Power BI dashboard to compare player statistics and performance trends.

The analysis produced a data-driven Playing XI with a projected 90% win probability, based on performance analytics and key metrics.

Skills: Web Scraping, Data Cleaning & Transformation, EDA, Performance Analysis
...
Description:
Built a comprehensive Power BI dashboard to monitor OT% (On-Time), IF% (In-Full), OTIF% (On-Time In-Full) KPIs across multiple regions. The project identified delivery gaps, performance anomalies, and actionable insights that helped improve service-level performance.

Insights from the dashboard revealed potential to save up to 20% of projected expansion costs by improving logistics efficiency.

Skills: KPI Tracking, Supply Chain Analytics, Power Query, Data Modelling
...
Description:
Designed an interactive Tableau dashboard using parameters, hierarchies, and calculated fields to help sales managers compare performance across regions. The dashboard visualized KPIs, trends, and category-wise performance, enabling data-driven decision-making.

Skills: Tableau Parameters, Calculated Fields, KPI Visualization
Technology: Tableau
...
🔗 LinkedIn: https://www.linkedin.com/in/gokul-alla-data-analyst/
